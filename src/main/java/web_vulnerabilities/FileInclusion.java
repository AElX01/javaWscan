...
public interface FileInclusion {

    // CHECK mightBeVulnerable() METHOD
    static boolean testLFI(InterceptedRequest interceptedRequest) {
    ...
    static IsVulnerableCodes isVulnerableToLFI(InterceptedRequest interceptedRequest) {
